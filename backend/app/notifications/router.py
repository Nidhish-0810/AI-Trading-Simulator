"""
Notifications schemas and router.
"""
import uuid
...
@router.post("/alerts", response_model=AlertResponse, status_code=201, summary="Create price alert")
...
@router.get("/alerts", response_model=List[AlertResponse], summary="List price alerts")
...
@router.delete("/alerts/{alert_id}", status_code=204, summary="Delete price alert")
...
@router.get("", response_model=List[NotificationResponse], summary="Get notifications")
